...
void main() {
  group('editSpecificFileASR', () {
    test('editSpecificFileASR', () async {
      ...
      final url = Uri.parse("${ApiRoutes.fileNlpEditASRUrl}/$testId");
      ...
      await apiService.editSpecificFileASR(testEditFile);
    ...
    test('editSpecificFileASR throws ClientException', () async {
      final jwtService = MockJwtService();
      final httpClient = MockClient();
      ...
      expectLater(apiService.editSpecificFileASR(testEditFile), throwsA(isA<ClientException>()));
    ...
    test('editSpecificFileASR throws ExistException', () async {
      final jwtService = MockJwtService();
      final httpClient = MockClient();
      ...
      expectLater(apiService.editSpecificFileASR(testEditFile), throwsA(isA<ExistException>()));

      await untilCalled(httpClient.put(url, headers: {"Content-Type": "application/json",'Authorization': 'Bearer $testJwt'},body: jsonEncode(testEditFile.formatJson())));
      verify(httpClient.put(url, headers: {"Content-Type": "application/json",'Authorization': 'Bearer $testJwt'},body: jsonEncode(testEditFile.formatJson()))).called(1);

    });
    test('editSpecificFileASR throws AuthException', () async {
      final jwtService = MockJwtService();
      final httpClient = MockClient();
      ...
      expectLater(apiService.editSpecificFileASR(testEditFile), throwsA(isA<AuthException>()));
    ...
    test('editSpecificFileASR throws ServerException', () async {
      final jwtService = MockJwtService();
      final httpClient = MockClient();
      ...
      expectLater(apiService.editSpecificFileASR(testEditFile), throwsA(isA<ServerException>()));

      await untilCalled(httpClient.put(url, headers: {"Content-Type": "application/json",'Authorization': 'Bearer $testJwt'},body: jsonEncode(testEditFile.formatJson())));
      verify(httpClient.put(url, headers: {"Content-Type": "application/json",'Authorization': 'Bearer $testJwt'},body: jsonEncode(testEditFile.formatJson()))).called(1);

    });
    test('editSpecificFileASR throws Other Exception', () async {
      final jwtService = MockJwtService();
      final httpClient = MockClient();
      ...
      expectLater(apiService.editSpecificFileASR(testEditFile), throwsA(isA<Exception>()));

      await untilCalled(httpClient.put(url, headers: {"Content-Type": "application/json",'Authorization': 'Bearer $testJwt'},body: jsonEncode(testEditFile.formatJson())));
      verify(httpClient.put(url, headers: {"Content-Type": "application/json",'Authorization': 'Bearer $testJwt'},body: jsonEncode(testEditFile.formatJson()))).called(1);

    });
    test('editSpecificFileASR throws AuthException(Jwt is null)', () async {
      final jwtService = MockJwtService();
      final httpClient = MockClient();
      ...
      expect(apiService.editSpecificFileASR(testEditFile), throwsA(isA<AuthException>()));
