...
// in study_savvy_app/test/bloc/bloc_article_improver_test.dart.
...
class _FakeJwtService_8 extends _i1.SmartFake implements _i3.JwtService {
  _FakeJwtService_8(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
/// A class which mocks [ArticleImproverService].
///
/// See the documentation for Mockito's code generation for more information.
class MockArticleImproverService extends _i1.Mock
    implements _i8.ArticleImproverService {
  MockArticleImproverService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.JwtService get jwtService => (super.noSuchMethod(
        Invocation.getter(#jwtService),
        returnValue: _FakeJwtService_8(
          this,
          Invocation.getter(#jwtService),
        ),
      ) as _i3.JwtService);
  @override
  set jwtService(_i3.JwtService? _jwtService) => super.noSuchMethod(
        Invocation.setter(
          #jwtService,
          _jwtService,
        ),
  ...
  @override
  _i5.Future<void> predictOcrGraph(_i9.ArticleImage? data) =>
      (super.noSuchMethod(
        Invocation.method(
          #predictOcrGraph,
          [data],
  ...
  @override
  _i5.Future<void> predictOcrText(_i9.ArticleText? data) => (super.noSuchMethod(
        Invocation.method(
          #predictOcrText,
          [data],
        ),
