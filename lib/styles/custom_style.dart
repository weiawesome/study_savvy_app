...
class LightStyle {
  ...
  static final ThemeData theme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleMedium: TextStyle(color: Color.fromRGBO(60, 60, 67, 0.6), fontSize:17, fontFamily: 'Play', fontWeight: FontWeight.bold),
      titleLarge: TextStyle(color: Color.fromRGBO(229, 229, 239, 1), fontSize:17, fontFamily: 'Play', fontWeight: FontWeight.bold),
...
class DarkStyle {
  ...
  static final ThemeData theme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleLarge: TextStyle(color: Color.fromRGBO(57, 57, 59, 0.8), fontSize:17, fontFamily: 'Play', fontWeight: FontWeight.bold),
